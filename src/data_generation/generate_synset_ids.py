...
def main(desired_classes_path=''):
    # Read synset ids of classes in ImageNet-21k
    synset_ids_21k = []
    path_21k = os.path.join(desired_classes_path, 'classes_in_imagenet_21k.csv')
    with open(path_21k, newline='') as csvfile:
    ...
    synset_ids_1k = []
    path_1k = os.path.join(desired_classes_path, 'classes_in_imagenet_1k.txt')
    with open(path_1k) as txtfile:
